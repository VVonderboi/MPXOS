...
char* itoa(int intin){
	...
	//malloc memory to the charArray
	//since concatenation would reverse the number might be better to do an array the length of the # of digits, how
	int i = 0;
	while(intin!=0){
		digit = intin%10;
		intin = intin/10;
